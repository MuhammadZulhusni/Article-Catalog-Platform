<div>
  ...
  <div class="mx-auto max-w-4xl lg:py-20">
    <div class="text-center">
      <h1 class="text-4xl sm:text-4xl md:text-5xl font-bold tracking-tight bg-gradient-to-r from-blue-500 to-black bg-clip-text text-transparent whitespace-nowrap drop-shadow-lg uppercase">
