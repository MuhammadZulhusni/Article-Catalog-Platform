<section class="relative isolate overflow-hidden bg-white px-6 py-16 sm:py-24 lg:px-8 rounded-3xl">
  ...
  <div class="mx-auto max-w-2xl lg:max-w-4xl">
    ...
    <figure class="mt-8">
      ...
      <figcaption class="mt-8 flex flex-col items-center">
        ...
        <div class="mt-2 text-base font-medium text-gray-900">Richard Branson</div>
      </figcaption>
    </figure>
  </div>
</section>
